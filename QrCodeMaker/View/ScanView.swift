...
public class ScanView: UIView {
    ...
    /// 边角颜色，默认红色
    public lazy var cornerColor = UIColor.white
    
    /// 边角宽度，默认2.0
    public lazy var cornerWidth:CGFloat = 5.0
    
    /// 扫描区周边颜色的 alpha 值，默认 0.6
    public lazy var backgroundAlpha:CGFloat = 0.1
...
extension ScanView{
    ...
    func drawScan(_ rect: CGRect) {
        ...
        /// 空白区域设置
        UIColor.clear.withAlphaComponent(backgroundAlpha).setFill()
